      ...
      <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-16 2xl:px-24">
        ...
        <div className="mb-12 md:mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            ...
            <h2 className="text-3xl md:text-[48px] lg:text-[56px] font-[family-name:var(--font-poppins-custom)] font-bold text-[#0f172a] tracking-[-0.02em] leading-[1.1]">
              <AnimatedText text={data.titleLine1} as="span" delay={0.1} /> <br className="hidden md:block" />
              <AnimatedText text={data.titleLine2} as="span" className="italic font-normal text-blue-600" delay={0.3} />
            </h2>
          </div>
          <AnimatedText
            ...
            delay={0.5}
            stagger={0.02}
            className="text-lg md:text-[20px] font-[family-name:var(--font-poppins-custom)] font-light text-gray-600 max-w-lg leading-[1.6]"
          />
        </div>
