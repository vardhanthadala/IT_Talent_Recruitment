      ...
      <div className="w-full max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-16 2xl:px-24">
        ...
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-[13px] font-[family-name:var(--font-poppins-custom)] text-gray-500">
            <Link href="/" className="text-blue-600 font-medium hover:underline transition-all">Sreehisoft Solutions.</Link> © {new Date().getFullYear()} All rights reserved. Powered By <a href="https://dexze.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-medium hover:underline transition-all">Dexze</a>
          </p>
        </div>
